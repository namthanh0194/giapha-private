...
export default function RootError({
  ...
  return (
    <div className='flex min-h-screen items-center justify-center bg-stone-50 p-4 font-sans text-stone-900'>
      <div className='w-full max-w-md rounded-2xl border border-stone-200 bg-white/70 p-6 text-center backdrop-blur-xl'>
        ...
        <p className='mt-2 text-sm text-stone-600'>
          Hệ thống gặp lỗi không mong muốn khi tải trang. Bạn có thể thử lại
