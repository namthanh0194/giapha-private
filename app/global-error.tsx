...
export default function GlobalError({
  ...
  return (
    <html lang='vi'>
      <body className='flex min-h-screen items-center justify-center bg-stone-50 p-4 font-sans text-stone-900 antialiased'>
        <div className='w-full max-w-md rounded-2xl border border-stone-200 bg-white/70 p-6 text-center backdrop-blur-xl'>
          ...
          <p className='mt-2 text-sm text-stone-600'>
            Toàn bộ ứng dụng tạm thời không phản hồi. Bạn có thể thử tải lại
